...
//    char pcKey[] = "  ds";
//    char* position;
//    position = StrSearch(pcHaystack,pcKey);
...
//int main(){
//
////    char string_1[] = "ROBOTICS";// string_2[100],string_3[100];
////
////    size_t n1 = StrGetLength(string_1);
////    printf("StrGetLength = %Iu\n", n1);
////    strlen(string_1);
////    size_t n2 = strlen(string_1);
////    printf("strlen = %Iu\n",  n2);
////
...
////
////    printf("string1 = %s\n",string_1 );
////    printf("Using StrCopy: string2 = %s\n",string_2 );
////    printf("Using strcopy: string3 = %s\n",string_3 );
////
